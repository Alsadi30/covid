...
const Product = ({product}) =>{
    ...
    const {AddProductNoAuth,AddProductThunk} = useStoreActions(actions => actions.Cart);
    ...
    return (
       <>
                        ...
                        <FlexContentSpace>
                            ...
                            <div>
                                <button onClick={handleAddToCart}><BsFillCartPlusFill size="35" color="#007580"></BsFillCartPlusFill></button>
                            </div>
                        </FlexContentSpace>
                        </>
